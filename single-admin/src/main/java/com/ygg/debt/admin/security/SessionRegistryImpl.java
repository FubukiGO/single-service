...
public class SessionRegistryImpl implements SessionRegistry, ApplicationListener<SessionDestroyedEvent> {
    private static final String SESSIONIDS = "JCSsessionIds";

    private static final String PRINCIPALS = "JCSprincipals";

    @Resource
    private RedisTemplate redisTemplate;

    private Logger logger = LoggerFactory.getLogger(SessionRegistryImpl.class);
